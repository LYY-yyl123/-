...
public:
    ...
    void del_timer(heap_timer *timer)
    {
        ...
        /*仅仅将目标定时器的回调函数设置为空，即所谓的延迟销毁。这将节省真正删除该定时器造成的开销。但这样做也容易使堆数组膨胀*/
        timer->cb_func = NULL;
    }
    /*获得堆顶部的定时器*/
...
private:
    /*最小堆的下虑操作，确保堆数组中以第hole个节点作为根的子数拥有最小堆的性质*/
